...
public class EmployeeController {
    ...
    public static void employeeController() throws NotFoundException {
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        Employee employee = employeeService.findById(deleteEmployeeID);
                        if (employee != null){
                            employeeService.delete(String.valueOf(employee));
                        }else {
                           try {
                               throw new NotFoundException("NotFoundException");
                           }catch (NotFoundException e){
                               System.err.println("Input id service again");
                           }
                        }
                        break;
                    case 4:
